...
We again notice that there is a -17.2C temperature reading that seems
suspicious.
...
Look at the correlation between temperature and wind speed; look at the
correlation between temperature and wind speed with hour and day of the
month
...
![](lab_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->

``` r
hist(met$wind.sp)
```

![](lab_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->

``` r
hist(met$temp)
```

![](lab_files/figure-gfm/unnamed-chunk-13-3.png)<!-- --> Look at where
the weather station with highest elevation is located
