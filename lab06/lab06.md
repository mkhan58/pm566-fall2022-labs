...
![](lab06_files/figure-gfm/barplot-of-specialties-count-1.png)<!-- -->
...
Redo Q2 visualization but remove stopwords before Bonus points if you
...
![](lab06_files/figure-gfm/unnamed-chunk-5-1.png)<!-- --> Removing the
stop words and numbers gives us a much better idea.

# Question 4

Repeat Q2 but this time tokenize into bi-grams. how does the result
change if you look at tri-grams?
...
![](lab06_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](lab06_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> Trigrams found
more medical word groups than bigrams
